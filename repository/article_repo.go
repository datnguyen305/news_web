...
func (r *ArticleRepository) SaveArticle(ctx context.Context, a models.Article) error {
...
func (r *ArticleRepository) GetArticlesByIDs(ctx context.Context, ids []int) ([]models.RelatedArticle, error) {
	if len(ids) == 0 {
